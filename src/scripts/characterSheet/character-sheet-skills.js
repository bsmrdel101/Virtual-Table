const renderCharacterSheetSkillsPage = (sheetContent) => {
    characterSheetPage = 'skills';
...
const fillCharacterSheetSkillsTableBody = () => {
    ...
    skills.forEach((skill) => {
        ...
        bindEventToSkills(skill, skillModifier);
    });
};

const skillRowInnerHtml = (skill, skillModifier) => `
    <tr>
